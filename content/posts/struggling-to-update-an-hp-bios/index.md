...
![System update utility not seeing flash drives](./updateutil.webp)
...
![HP BIOS Recovery failure screen](./recovery.webp)
...
![HP System BIOS Update Utility failing to recognize any drives](./utilfull.webp)
...
![The HP 4-1 USB creation utility](./biosunzip.webp)
...
![HP System BIOS Update utility suddenly working](updating.webp)

It seems to have worked!

![HP BIOS Updating](./flashing.webp)

And finally, we can confirm it updated from F.15:

![BIOS is now at F.17](./dmidecode.webp)
