...
date = '2022-04-15'
draft = false
title = 'Converting Aspy.dev to Solid.js'
+++
...
Shown above is the code for the navbar, which I can just import anywhere across the rest of the project using `import NavBar from '(path relative to file)/navbar.jsx'` and inserting a `<NavBar/>` element
