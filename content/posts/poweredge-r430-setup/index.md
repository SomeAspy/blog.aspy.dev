...
![Picture of the R430 without the cover on](./ServerTop.jpg)
...
![This screenshot was taken after I figured out how to update the BIOS](./image.png)
...
![I didn't have an iDRAC license properly setup at the time I did this, so I couldn't remote in for a screenshot](./DellBIOSUpdaterCensored.jpg)
...
![LIC012: The license file does not exist. Re-import the license.](./LicenseDoesNotExist.png)
...
![Dell's offering of trial licenses](./image-1.png)
...
![Uploading the new iDRAC firmware](./LicenseUploading.png)
...
![iDRAC warning about resetting](./image-3.png)
...
![Checking the firmware version before rebooting the server after an update](./image-6.png)
...
![The updater script from dell running on Debian live](./image-7.png)
...
![The HTML5 Virtual Console](./image-8.png)
...
![HTTPS added as a firmware update option](./image-9.png)

Much easier than having to find all the packages yourself and installing them.

![The Lifecycle Controller installing firmware updates](./image-11.png)

In the end, all that was lost were dates, and my time.

![All firmware items are up to date, with some reset dates.](./image-12.png)
