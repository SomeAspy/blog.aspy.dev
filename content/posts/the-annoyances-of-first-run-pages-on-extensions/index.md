...
!["Installing" Adblock Plus...](./fakeinstall.webp)
...
![Adblock plus guilt tripping you into donations.](./donate.webp)
...
![Adblock Plus policies, with `suppress_first_run_page` highlighted](suppress.webp)
...
![`suppress_first_run_page` is now `true`!](./supresstrue.webp)
...
![Screencastify policy options](./screencast.webp)
...
![Refined GitHub welcome page, with the token requirement highlighted](./refinedgithub.webp)
